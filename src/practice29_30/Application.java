...
public class Application {
    public static List<String> withStream(String str) {
        ...
        Stream.of(str.split("[\\p{Punct}\\s]+")).collect(Collectors.groupingBy(String::toLowerCase, Collectors.counting())).entrySet().stream().
                sorted(
                        (elem1, elem2) -> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n" + withoutStream(str));
        System.out.println("Duration without Stream API: " + (System.currentTimeMillis() - start) + "ms\n");
        start = System.currentTimeMillis();
        System.out.println(withStream(str));
        System.out.println("Duration with Stream API: " + (System.currentTimeMillis() - start) + "ms\n");
    }
}
